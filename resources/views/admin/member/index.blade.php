                            ...
                            <div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none">
                                <div class="modal-dialog" style="width:55%">
                                    <div class="modal-content">
                                                ...
                                                <div class="m-t-20">
                                                <form role="form" action="{{route('admin.member.store')}}" method="POST">
                                                    {{csrf_field()}}
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <select name="jenis_kelamin" id="" class="form-control custom-select custom-select-lg mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Member Tables</h3>
                                    </div>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$row->tlp}}</td>
                                                    <td>
                                                        <a href="{{route('admin.member.edit',$row->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{url('admin/member/destroy',$row->id)}}" onclick="return confirm('apa kamu serius?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
